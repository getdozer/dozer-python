...
class IngestClient:
    ...
    def ingest_raw_stream(self, generator):
    ...
    def ingest_df(self, schema_name, df, seq_no=1):
    ...
    def ingest_df_arrow(self, schema_name, df, batch_size=BATCH_SIZE, seq_no=1):
